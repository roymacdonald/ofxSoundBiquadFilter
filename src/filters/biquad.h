...
public:
    ...
    virtual void calculate_coeffs(float a_freq, float a_q, float a_gain, float a_bandWidth, int fs) = 0;
//    virtual tp_coeffs& calculate_coeffs(int fc, int fs){}
//    virtual tp_coeffs& calculate_coeffs(float gain_db, float Q, int fc, int fs){}
//    virtual tp_coeffs& calculate_coeffs(float gain_db, int fc, int fs){}
//    virtual tp_coeffs& calculate_coeffs(float bw, int fc, int fs){}
//    virtual tp_coeffs& calculate_coeffs(float Q, int fc, int fs){}
//    virtual tp_coeffs& calculate_coeffs(float Q, int fs){}
